...
redisCrd.create(testObj, function(obj){
...
redisCrd.delete(rem1.time, function(reply){
  assert.equal(reply, 1);
  console.log("#test3 passed");
});


console.log("#Test 2: check read method retrieves entries from the db with the latest entries first");
var test1 = {name: "nikki", time: "1234"};
var test2 = {name: "michelle", time: "1235"};
redisCrd.create(test1, function(){});
redisCrd.create(test2, function(){});
redisCrd.read(function(obj){
